...
/**
  * Created by Aditya on October 22, 2017.
  */
object Multiply {
  ...
  def getFirstMatrix(sc: SparkContext, args: Array[String], local: Boolean): RDD[(Int, Elem)] = {
    if (local)
      sc.textFile("C:\\Users\\Aditya\\Desktop\\MS\\Fall 17\\Cloud Computing\\project3\\M-matrix-small.txt").map(line => {
        val a = line.split(",")
  ...
  def getSecondMatrix(sc: SparkContext, args: Array[String], local: Boolean): RDD[(Int, Elem)] = {
    if (local)
      sc.textFile("C:\\Users\\Aditya\\Desktop\\MS\\Fall 17\\Cloud Computing\\project3\\N-matrix-small.txt").map(line => {
        val a = line.split(",")
  ...
  def saveOutput(reducer2Output: RDD[(Pair, Double)], args: Array[String], local: Boolean): Unit = {
    if (local)
      reducer2Output.saveAsTextFile("C:\\Users\\Aditya\\Desktop\\MS\\Fall 17\\Cloud Computing\\project3\\smalloutput")
    else
